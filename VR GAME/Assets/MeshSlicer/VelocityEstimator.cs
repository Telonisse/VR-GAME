...
public class VelocityEstimator : MonoBehaviour
{
    ...
    {
        FinishEstimatingVelocity(); // Stop any ongoing coroutine
    ...
    void Awake()
    {
        // Initialize velocity and angular velocity samples
    ...
    void OnEnable()
    {
        // Reset samples and begin estimating when the GameObject is enabled
        ResetSamples();
        BeginEstimatingVelocity();
    }
    ...
    void OnDisable()
    {
        // Stop estimating when the GameObject is disabled
    ...
    {
        // Reset the sample arrays to avoid stale data
        sampleCount = 0;
        ...
        {
            angularVelocitySamples[i] = Vector3.zero;
        }
    }
